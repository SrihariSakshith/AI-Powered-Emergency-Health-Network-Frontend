...
const PatientProfile = ({ username }) => {
    ...
    useEffect(() => {
        const fetchPatientData = async () => {
            try {
                const response = await axios.get(`https://ai-powered-emergency-health-network.onrender.com/patient-profile/api/patient/${username}`);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`https://ai-powered-emergency-health-network.onrender.com/patient-profile/api/patient/${username}`, {
                report: formData,
                donation,
            });
    ...
    const handleRemoveDonation = async () => {
        try {
            await axios.delete(`https://ai-powered-emergency-health-network.onrender.com/patient-profile/api/patient/${username}/donation`);
            setHasDonated(false);
            setDonation('');
